	...
	<div class="member_content" style="overflow: auto;">
		...
		<c:if test="${pageNow > 0}">
			...
			<div class="controlPage">
				<c:if test="${pageNow ==1 }">
					<a href="ShowOrdList?type=${osId}&pageNow=${pageNow }"> PREV <</a>
				</c:if>

				<c:if test="${pageNow >1 }">
					<a href="ShowOrdList?type=${osId}&pageNow=${pageNow -1}">PREV <</a>
				</c:if>
				...
				<c:if test="${pageNow==totalPage}">
					<a href="ShowOrdList?type=${osId}&pageNow=${pageNow }"> >NEXT</a>
				</c:if>
				<c:if test="${pageNow <totalPage }">
					<a href="ShowOrdList?type=${osId}&pageNow=${pageNow +1}"> >NEXT</a>
				</c:if>
